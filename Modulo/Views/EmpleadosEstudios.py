...
def empleados_estudios_index(request):
    ...
    return render(request, 'EmpleadosEstudios/EmpleadosEstudiosIndex.html', {'empleados_estudios': empleados_estudios})
...
def empleados_estudios_crear(request):
    ...
    return render(request, 'EmpleadosEstudios/EmpleadosEstudiosForm.html', {'form': form})  
