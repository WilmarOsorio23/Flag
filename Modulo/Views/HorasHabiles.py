...
def horas_habiles_index(request):
    ...
    return render(request, 'HorasHabiles/HorasHabilesIndex.html', {'horas_habiles': horas_habiles})
...
def horas_habiles_crear(request):
    ...
    return render(request, 'HorasHabiles/HorasHabilesCrear.html', {'form': form})
