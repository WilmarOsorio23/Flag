...
def historial_cargos_index(request):
    ...
    return render(request, 'HistorialCargos/HistorialCargosIndex.html', {'historial_cargos_data': historial_cargos_data})
...
def historial_cargos_crear(request):
    ...
    return render(request, 'HistorialCargos/HistorialCargosForm.html', {'form': form})   
