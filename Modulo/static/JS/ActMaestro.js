document.addEventListener('DOMContentLoaded', function () {
    ...
    window.saveRow = function () {
        ...
        const actividadId = selected.value;
        const csrfToken = document.querySelector('[name=csrfmiddlewaretoken]').value;

        console.log(`Guardando ID: ${actividadId}, Descripción: ${nuevaDescripcion}`);

        fetch(`/Act_Maestro/editar/${actividadId}/`, {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                Descripcion_Act: nuevaDescripcion
            })
        })
