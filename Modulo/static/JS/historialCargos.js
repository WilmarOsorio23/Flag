document.addEventListener('DOMContentLoaded', function() {
    ...
    window.saveRow = function() {
        ...
        let data = {
            'FechaInicio': row.querySelector('input[name="fecha_Inicio"]').value,
            'FechaFin': row.querySelector('input[name="Fecha_Fin"]').value
        };
       ...
       console.log(id)
       console.log(data)
       fetch(`/historial_cargos/editar/${id}/`, {
            method: 'POST',
            headers: {
    ...
    window.enableEdit = function() {
        ...
        let editables=["fecha_Inicio","Fecha_Fin"]
