document.addEventListener('DOMContentLoaded', function () {
    ...
    window.saveRow = function () {
      ...
      const payload = { LineaId: lineaId, ClienteId: clienteId, CentroCostoId: centroCostoId };
    ...
    // Sorting (igual patrón al módulo base)
